...
import com.cgi.fic.tests.domain.User;
import com.cgi.fic.tests.service.InvalidPasswordException;
import com.cgi.fic.tests.service.MailService;
import com.cgi.fic.tests.service.UserService;
import com.cgi.fic.tests.service.UsernameAlreadyUsedException;
import com.cgi.fic.tests.service.dto.PasswordChangeDTO;
import com.cgi.fic.tests.service.dto.UserDTO;
import com.cgi.fic.tests.web.rest.errors.EmailAlreadyUsedException;
import com.cgi.fic.tests.web.rest.errors.EmailNotFoundException;
import com.cgi.fic.tests.web.rest.errors.LoginAlreadyUsedException;
import com.cgi.fic.tests.web.rest.vm.KeyAndPasswordVM;
import com.cgi.fic.tests.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.cgi.fic.tests.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
